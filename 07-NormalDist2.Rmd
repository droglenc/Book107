...
For example, suppose that the heights of a population of students is known to be H~N(66,3). The proportion of students in this population that have a height less than 71 inches is computed below. Thus, approximately `r formatC(pnorm(71,mean=66,sd=3)*100,format="f",digits=1)`% of students in this population have a height less than 71 inches (Figure \@ref(fig:NormZCalc1)).
