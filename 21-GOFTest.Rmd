...
1. &chi;^2^=$\frac{(61.6-54)^{2}}{54} + \frac{(18.4-26)^{2}}{26}$=1.070 + 2.222 = 3.292 with 2-1=1 df.
1. p-value=`r kPvalue(pchisq(3.292,df=1,lower.tail=FALSE),include.p=FALSE,latex=FALSE)`.
...
( distrib(3.292,distrib="chisq",df=1,lower.tail=FALSE) )
( distrib(0.95,type="q") )
```
