...
it is apparent that the SE of $\bar{\text{x}}_{1}-\bar{\text{x}}_{2}$ (i.e., the statistic) is needed. Unfortunately, the calculation of this standard error depends on whether the two population variances are equal or not. When the variances are approximately equal (discussed in Section \@ref(LevenesTest)), the standard error of $\bar{\text{x}}_{1}-\bar{\text{x}}_{2}$ is
...
1. $\bar{\text{x}}_{s}-\bar{\text{x}}_{0}$ = 51.46 - 47.49 = 3.97. Additionally, $s_{p}^{2}=\frac{(25-1)5.975^{2}+(25-1)6.721^{2}}{25+25-2}$ = 40.44 and $SE_{\bar{\text{x}}_{s}-\bar{\text{x}}_{o}}=\sqrt{40.44\left(\frac{1}{25}+\frac{1}{25} \right)}$ = 1.799.
...
1. $\bar{\text{x}}_{w}-\bar{\text{x}}_{wo}$ = 4.2-5.9 = -1.7. Additionally, $s_{p}^{2}=\frac{(32-1)1.2^{2}+(36-1)1.9^{2}}{32+36-2}$ = 2.59 and $SE_{\bar{\text{x}}_{w}-\bar{\text{x}}_{wo}}=\sqrt{2.59\left(\frac{1}{32}+\frac{1}{36} \right)}$ = 0.391.
