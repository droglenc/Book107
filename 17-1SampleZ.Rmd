...
1. A 1-Sample Z-Test is required because (i) a quantitative variable (intra-class travel time) was measured, (ii) individuals from one group (or population) is considered (students at the Dean's school), and (iii) $\sigma$ is thought to be known (=1.60 mins).
...
1. The assumptions are met because ...
    1. n=100&geq;30, and
    1. $\sigma$ is thought to be known (=1.60 mins).
1. $\bar{x}$=10.12.
