...
```{r CIAlt1, echo=FALSE, fig.show="hold", fig.cap="Range (95%) of sample means that would be produced by particular population means in the Square Lake fish length example (**Left**) and the ranges intercepted by $\\bar{\text{x}}$=100.04 mm (**Right**)."}
