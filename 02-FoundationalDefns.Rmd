...
SLpop1 <- SLpop + geom_point(data=SL1,color=clrs[4])
SLhist1 <- SLhist %+% SL1 +
    geom_histogram(color="gray10",fill=clrs[4],
                   closed="left",boundary=0,binwidth=hwid)
...
<img src="zimgs/HawkRidge.jpg" alt="Decoration" class="img-right">
...
SLpop2 <- SLpop + geom_point(data=SL2,color=clrs[4])
SLhist2 <- SLhist1 %+% SL2
SLpop3 <- SLpop + geom_point(data=SL3,color=clrs[4])
SLhist3 <- SLhist1 %+% SL3
SLpop4 <- SLpop + geom_point(data=SL4,color=clrs[4])
SLhist4 <- SLhist1 %+% SL4
